...
class SLIM_RMSE_Cython(Similarity_Matrix_Recommender, Recommender):
    ...
    def fit(self,learning_rate = 1e-2, gamma=0, beta=0,topK = 300, logFile='SLIM_RMSE_training.log',validation_every_n = 1,validation_function=None,
        ...
        self.cythonEpoch = SLIM_RMSE_Cython_Epoch(unique_movies=self.unique_movies, URM_train=self.URM_train,learning_rate = learning_rate, gamma=gamma, beta=beta, iterations=1, gradient_option="adam")
