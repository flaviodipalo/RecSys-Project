...
class SLIM_RMSE_Cython(Similarity_Matrix_Recommender, Recommender):
    ...
    def fit(self, learning_rate = 1e-2, l1_penalty=0, l2_penalty=0,topK = 100, logFile='SLIM_RMSE_training.log',validation_every_n = 1,validation_function=None,
            stop_on_validation=True, lower_validatons_allowed=5, validation_metric="map", epochs=3,similarity_matrix_normalized=False,URM_validation=None):
        ...
        while currentEpoch < epochs and not convergence:
            ...
            currentEpoch += 1
        self.W_sparse = self.S_best.copy()
        #self.get_S_incremental_and_set_W()
